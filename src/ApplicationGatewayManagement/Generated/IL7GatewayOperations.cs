...
namespace Microsoft.WindowsAzure.Management.ApplicationGateway
{
    ...
    /// more information)
    /// </summary>
    public partial interface IL7GatewayOperations
    {
        /// <summary>
        ...
        /// </returns>
        Task<ApplicationGatewayConfiguration> GetConfigAsync(string gatewayName, CancellationToken cancellationToken);
